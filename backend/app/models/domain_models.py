...
class CrimeRecord(Base):
    ...
    title = Column(String(250), nullable=False, default="Untitled crime record")
    crime_type = Column(String(100), nullable=False)
    crime_category = Column(String(50))
    crime_subcategory = Column(String(100))
    priority = Column(String(20), default="MEDIUM")
    status = Column(String(40), default="UNDER_REVIEW")
    district = Column(String(100), index=True, default="Bengaluru Central")
    station_name = Column(String(120), default="Unassigned Station")
    ...
    arrests = Column(Integer, default=0)
    documents = Column(Integer, default=0)
    property_stolen = Column(JSON)
    property_recovered = Column(JSON)
